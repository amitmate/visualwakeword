(FOR YC - This is a sample model and highlights the process. We have working models for more complex use-cases such as anpr, face-reco, depth, drl, speech etc. For sample innovations in the area of Robotics - pls see DRL_AmitMate.pdf - added to slack channel#snpe)
